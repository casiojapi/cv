...
\cventry
    ...
    {
        {\begin{itemize}
        \item   \spa{Desarrollador en un equipo dedicado a la implementacion y desarrollo de una billetera virtual del banco.}
                \en{Developer working in a team focused on bank's digital wallet project.}
        \end{itemize}}
    }
