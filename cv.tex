...
\extrainfo{
  \begin{tabular}{@{\hspace{2em}}c@{\hspace{2em}}}
    \href{https://www.linkedin.com/in/maximo-santoro/}{\faLinkedin \vspace{0.4mm} maximo-santoro} • \href{https://www.github.com/casiojapi/}{ \faGithub \vspace{0.4mm} casiojapi}
  \end{tabular}
}
...
\cventry
    {\spa{Agosto 2021 - Presente}\en{August 2021 - Now}}
    {\spa{Desarrollador Backend}\en{Backend Engineer}}
    {\href{https://www.bbva.com.ar/}{BBVA}}{}{}
    {
        {\begin{itemize}
        \item   \spa{Trabajando en APIs de MODO y cashback en pagos con tarjetas de credito usando Java Spring.}
                \en{Working in bank's digital wallet and credit card cashabacks APIs using Java Spring.}
        \end{itemize}}
    }
...
\cventry
    ...
    {
        {\begin{itemize}
        \item   \spa{Diseño, desarrollo y mantenimiento de paginas web simples para pequeños clientes.} 
...
\cventry
    ...
    {
        \begin{itemize}
        \item   \spa{Corrijo trabajos practicos de programacion escritos en C.} 
...
\begin{itemize}
    ...
    \item \textbf{\spa{Experiencia con}\en{Experience with}:} Java Spring, C, MySQL, Python/Django, Solidity, Javascript, Smalltalk, C\#/Unity, GDScript.
...
\begin{itemize}
    \item \textbf{{\href{https://open.spotify.com/artist/1gmAvUNIqrPSGklxtoj514?si=zmeSuhggQwSlc_M0m4N1xA}{{{\spa{hago música}\en{i make music}: }}(spotify: bokki)}}}
