...
\en{
    \begin{textblock*}{1.51cm}(19cm,0.2cm)
        \begin{shaded*}
        \centering
            \href{https://maximosan.github.io/cv/cv.pdf}{ENG}
        \end{shaded*}
    \end{textblock*}
}
...
\begin{itemize}
    ...
    \item \textbf{\spa{Experiencia con:}\en{Experience with:}} Java, C, MySQL, Python/Django, Javascript, Smalltalk, C\#/Unity, GDScript.
